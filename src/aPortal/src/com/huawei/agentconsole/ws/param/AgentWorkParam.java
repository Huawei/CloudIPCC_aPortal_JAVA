...
public class AgentWorkParam
{
    /**
     * 报表类型：2：日报表, 3：月报表，4：周报表
     */
    @Range(min = 2, max = 4)
    @FormParam("agentWorkReport_type")
    ...
    @NotBlank
    @FormParam("agentWorkReport_startTime")
    ...
    @Pattern(regexp = ParamPatternConstant.REPORT_TIME_PATTERN)
    @NotBlank
    @FormParam("agentWorkReport_endTime")
    private String endTime;
    
    /**
     * 坐席（不超过50个）
     */
    @FormParam("agentWorkReport_agentId")
